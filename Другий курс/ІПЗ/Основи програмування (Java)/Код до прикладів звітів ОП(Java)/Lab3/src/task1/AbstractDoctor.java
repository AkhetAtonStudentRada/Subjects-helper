...
abstract class AbstractDoctor {
    ...
    public abstract void setWorkExperience(double workExperience);
    ...
    public static void test(){
        ...
        class AbstractDoctorTestClass extends AbstractDoctor {
            ...
            public AbstractDoctorTestClass(String surname, double workExperience, Appointment[] appointments) {
